...
use surfer_translation_types::{
    SubFieldTranslationResult, TranslationResult, Translator, TrueName, ValueRepr,
};
...
impl Translator<VarId, ScopeId, Message> for SpadeTranslator {
    ...
    fn variable_true_name(&self, variable: &VariableMeta) -> Option<TrueName> {
        let info = self
            .state
