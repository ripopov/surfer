...
pub struct SystemState {
    ...
    /// The translator enums for each variable (new field added here)
    translator_enums: HashMap<String, HashMap<String, String>>, // Updated to HashMap type
}
...
impl SystemState {
    pub fn new() -> Self {
        ...
        let translator_enums: HashMap<String, HashMap<String, String>> = HashMap::new(); // Replace with appropriate initialization
        let translators = all_translators(None);
    ...
    pub fn update(&mut self, message: Message) {
        match message {
            ...
            Message::ReloadConfig => {
                ...
                {
                    self.sys.translators = all_translators(Some(self.sys.translator_enums.clone()));
                    self.config = config;
                    if let Some(ctx) = &self.sys.context.as_ref() {
                        ctx.set_visuals(self.get_visuals());
                    }
