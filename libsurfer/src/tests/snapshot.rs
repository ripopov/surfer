        ...
        || {
            ...
            let msgs = vec![
                ...
                Message::VariableFormatChange(
                    MessageVar::Single(DisplayedFieldRef {
                ...
                Message::ItemColorChange(MessageVar::Selected, Some("green".to_string())),
                ...
                Message::ItemColorChange(MessageVar::Selected, Some("orange".to_string())),
                Message::SetMarker {
                    id: 1,
                    time: 1912676.to_bigint().unwrap(),
                },
                Message::ItemColorChange(MessageVar::Selected, Some("violet".to_string())),
...
snapshot_ui_with_file_and_msgs! {clock_pulses_render_line, "examples/counter.vcd", [
    ...
    Message::VariableFormatChange(MessageVar::Single(DisplayedFieldRef{item: DisplayedItemRef(2), field: vec![]}), String::from("Clock")),
...
snapshot_ui_with_file_and_msgs! {divider_works, "examples/counter.vcd", [
    ...
    Message::AddScope(ScopeRef::from_strs(&["tb"]), false),
    Message::ItemBackgroundColorChange(MessageVar::Single(VisibleItemIndex(4)), Some("Blue".to_string())),
    Message::ItemColorChange(MessageVar::Single(VisibleItemIndex(4)), Some("Green".to_string()))
]}
...
snapshot_ui_with_file_and_msgs! {markers_work, "examples/counter.vcd", [
    ...
    Message::ItemColorChange(MessageVar::Single(VisibleItemIndex(4)), Some("Blue".to_string())),
    Message::CursorSet(BigInt::from(200)),
    Message::MoveMarkerToCursor(1),
    Message::ItemColorChange(MessageVar::Single(VisibleItemIndex(5)), Some("Green".to_string())),
...
snapshot_ui_with_file_and_msgs! {height_scaling, "examples/counter.vcd", [
    Message::AddScope(ScopeRef::from_strs(&["tb"]), false),
    Message::ItemHeightScalingFactorChange(MessageVar::Single(VisibleItemIndex(2)), 4.0)
]}
...
snapshot_ui_with_file_and_msgs! {selection_extend_change_color, "examples/counter.vcd", [
    ...
    Message::FocusItem(VisibleItemIndex(2)),
    Message::MoveFocus(MoveDir::Up, 1, true),
    Message::ItemColorChange(MessageVar::Selected, Some("Blue".to_string())),
]}
