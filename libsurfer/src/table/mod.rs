...
pub use model::{
    AnalysisKind, AnalysisParams, ColumnResizeResult, MIN_COLUMN_WIDTH, MultiSignalEntry,
    NavigationResult, ScrollTarget, SelectionUpdate, TableAction, TableCell, TableColumn,
